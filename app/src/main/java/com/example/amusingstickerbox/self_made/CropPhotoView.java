...
public class CropPhotoView extends View {
    ...
    public float leftLine=-1;//选区左线
    public float topLine=-1;//选区上线
    public float rightLine=-1;//选区右线
    public float bottomLine=-1;//选区下线
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        shadowPaint.setColor(Color.parseColor("#66FFFFFF"));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //绘制扇形
        linePaint.setColor(Color.parseColor("#EFC447"));
     ...
     * @param height 设置选框的高
     */
    public void Set_Line(float width,float height){
        topLine=width;
        bottomLine = width;
        leftLine = height;
        rightLine = height;
